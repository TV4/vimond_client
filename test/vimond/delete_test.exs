defmodule Vimond.Client.DeleteTest do
  ...
  describe "user authenticated" do
    test "with a valid session" do
      ...
      assert delete("12345", "blah", http_client) == {:ok, %{message: "User has been deleted"}}
    end
    ...
    test "with an invalid session" do
      ...
      assert delete("12345", "blah", http_client) ==
               {:error,
                %{
  ...
  describe "app authenticated" do
    test "succeeds" do
      http_client =
        fake HTTPClient do
          def delete("https://vimond-rest-api.example.com/api/platform/user/12345",
                Accept: "application/json; v=3; charset=UTF-8",
                "Content-Type": "application/json; v=3; charset=UTF-8",
      ...
      assert delete_signed("12345", http_client) == {:ok, %{message: "User has been deleted"}}
    end
    ...
    test "when Vimond returns error" do
      ...
      assert delete_signed("12345", http_client) ==
    ...
    test "with unexpected error" do
      http_client =
        fake HTTPClient do
          def delete(_, _), do: %HTTPotion.ErrorResponse{message: "Oh noes!"}
        end
